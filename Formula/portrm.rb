class Portrm < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/abhishekayu/portrm/releases/download/v1.0.0/ptrm-darwin-arm64.tar.gz"
      sha256 "15de0084e26066cb037d76edff191930992cb8fc487ac7d780ce9aabcd4aa6a5"
    else
      url "https://github.com/abhishekayu/portrm/releases/download/v1.0.0/ptrm-darwin-amd64.tar.gz"
      sha256 "23f58b742175c8a6458d807943c794cc3cbf9e93474167790ad748366a78bbe3"
    end
  end

  on_linux do
    url "https://github.com/abhishekayu/portrm/releases/download/v1.0.0/ptrm-linux-amd64.tar.gz"
