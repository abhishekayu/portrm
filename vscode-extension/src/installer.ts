...
function getTarget(): string | undefined {
  ...
  if (platform === "darwin" && arch === "arm64") { return "portrm-darwin-arm64"; }
  if (platform === "darwin" && arch === "x64") { return "portrm-darwin-amd64"; }
  if (platform === "linux" && arch === "x64") { return "portrm-linux-amd64"; }
  if (platform === "linux" && arch === "arm64") { return "portrm-linux-arm64"; }
  if (platform === "win32" && arch === "x64") { return "portrm-windows-amd64"; }
  return undefined;
}
